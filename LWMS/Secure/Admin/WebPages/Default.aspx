                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mt-3 mb-0">
                                <span class="text-danger me-1"><i class="mdi mdi-arrow-down-bold me-1"></i>0.82%</span> since last week
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mt-3 mb-0">
                                <span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>10.51%</span> since last week
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-4">
                                    <div class="mt-4 mt-sm-0">
                                        <img src="../../../Assets/Admin/images/setup-analytics-amico.svg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-centered table-nowrap">
                                        <tbody>
                                            <tr>
                                                <td style="width: 20px;">
                                                    <img src="../../../Assets/Admin/images/users/avatar-4.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../../../Assets/Admin/images/users/avatar-5.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../../../Assets/Admin/images/users/avatar-6.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../../../Assets/Admin/images/users/avatar-7.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../../../Assets/Admin/images/users/avatar-8.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../../../Assets/Admin/images/users/avatar-2.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
                                                    <h6 class="font-size-15 mb-1 fw-normal">Marie Kim</h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="../../../Assets/Admin/images/users/avatar-1.jpg" class="avatar-xs rounded-circle " alt="..."></td>
                                                <td>
                                                    <h6 class="font-size-15 mb-1 fw-normal">Sonya Henshaw</h6>
